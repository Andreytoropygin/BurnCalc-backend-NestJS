...
export class InitDB1773351497502 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Compounds" ("id" SERIAL NOT NULL, "title" character varying(50) NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "image_url" character varying(100), "video_url" character varying(100), "formula" character varying(50) NOT NULL, "description_eng" character varying(150) NOT NULL, "description_rus" character varying(150) NOT NULL, "specific_h2o_volume" numeric(10,4) NOT NULL, "specific_co2_volume" numeric(10,4) NOT NULL, "class" character varying(50) NOT NULL, CONSTRAINT "UQ_115427cd41466880a5934527025" UNIQUE ("title"), CONSTRAINT "UQ_b46b26dae605b0cac4474ecca3f" UNIQUE ("formula"), CONSTRAINT "PK_6d49e31a789516690c0410cd84b" PRIMARY KEY ("id"))`);
