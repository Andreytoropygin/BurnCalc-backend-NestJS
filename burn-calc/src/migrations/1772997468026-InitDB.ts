...
export class InitDB1772997468026 implements MigrationInterface {
    name = 'InitDB1772997468026'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Request_combustion" ("id" SERIAL NOT NULL, "request_id" integer NOT NULL, "combustion_id" integer NOT NULL, "comment" character varying, "amount" numeric(10,4), CONSTRAINT "uq_request_combustion" UNIQUE ("request_id", "combustion_id"), CONSTRAINT "PK_106557359c33d99bcbfd9361eee" PRIMARY KEY ("id"))`);
