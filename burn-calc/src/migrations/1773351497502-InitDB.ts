...
export class InitDB1773351497502 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Combustions" ("id" SERIAL NOT NULL, "user_id" integer NOT NULL, "status" character varying(20) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "formed_at" TIMESTAMP, "completed_at" TIMESTAMP, "expert_id" integer, "sample_description" text, "co2_volume" numeric(10,4), "h2o_volume" numeric(10,4), CONSTRAINT "PK_ac02fed4cfde0fc31c8324e77d2" PRIMARY KEY ("id"))`);
